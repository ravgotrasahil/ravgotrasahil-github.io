...
In this walk-through, you will learn a few tools for summarizing categorical data using contingency tables.  You will also learn how to turn a numerical variable into a categorical variable using the `cut` function.
...
odds_ratio
```
An odds ratio of about 12 quantifies the extent to which males were more likely to die than females.
