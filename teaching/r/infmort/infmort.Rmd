...
In this walk-through, you'll learn to fit a power law curve to data using linear least squares and the log transformation.  The log transform is often useful for data bounded below by 0, or data that span many orders of magnitude.
...
As the above example suggests, the `curve` function allows you to treat R as a graphing calculator.  It can plot functions or add those functions to existing scatter plots, as above.  If you want to see this function in action, try a few examples:
```
